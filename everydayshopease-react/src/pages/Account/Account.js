    ...
    <div className="p-8">
      ...
      {userInfo?.email && (
        <>
          ...
          <p>귀하의 계정에 오신 것을 환영합니다</p>
          <div className="md:flex mt-4">
            <ul className="flex-col md:w-[100px] space-y-4 text-sm font-medium text-center text-gray-500">
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      "inline-flex items-center px-4 py-3 text-white bg-black rounded-lg active w-full",
                    ].join(" ")
                  }
                >
                  <svg
